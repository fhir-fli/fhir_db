...
class FhirDb<R extends FhirNode, T extends Object> extends _$FhirDb {
  ...
  FhirDb(super.e, {required this.model});

  /// The FHIR version's model: how a resource is parsed, written and
  /// stamped, and the version's generated search and compartment data.
  final FhirModel<R, T> model;
